...
from tools.LeNet5_custom import LeNet_custom as LeNet_custom
...
data_train = CIFAR10('./data/cifar10', train=True, download=True, transform=train_transforms)
data_test = CIFAR10('./data/cifar10', train=False, download=True, transform=test_transforms)
...
def cifar_main(args):
    ...
    for q in Q:
        for e in eps:
            succ_pair, robust_pair = test(net_H, sep_dataloader, eps=e/255, alpha=2/255, iters=40)
