...
- python main.py --mnist 0 --cifar 1 --lidar 0 --metric q_inv --model_type cnn --model_name ori --model_path CNN/models/ --mnist_res_path res/q_inv/
...
- python test.py --mnist 0 --cifar 1 --lidar 0 --metric q_inv --model_type cnn --model_name ori --model_path CNN/models/ --mnist_data_path res/q_inv/ --mnist_res_path statistics/q_inv/ --dataset cifar
