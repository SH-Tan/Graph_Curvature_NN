...
def remove_edge_fc_perE_alllabels(args):
    seed = 59
    set_seed(seed)
            ...
            with open(res_path + "edge_fc_tanh_" + str(l) + str(layer_num) + ".txt", "w+") as ff:
                ...
                for (images, labels) in sep_dataloader[l]:
                    for idx in range(images.shape[0]):
                        ...
                        remove_num = [0, (int)(len(neg_e_other)*0.5), len(neg_e_other), (int)(len(pos_e)*0.1), (int)(len(pos_e)*0.3), (int)(len(pos_e)*0.4), (int)(len(pos_e)*0.5), (int)(len(pos_e)*0.7), (int)(len(pos_e)*0.9), (int)(len(pos_e))]
