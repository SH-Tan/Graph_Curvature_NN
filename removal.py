...
from CNN.curvature_sep_test import curv_single_label
...
def parse_args():
    ...
    parse.add_argument('--single_label', type=int, default=0, required=False, help='If test single_label forgetting')
